...
案件ごとの勤務枠、必要人数、従業員の勤務不可情報、確定シフト、就労報告、月次集計を管理できます。

## コンセプト

ケータリング現場では、案件ごとに勤務日・勤務時間・集合場所・必要人数・食事の有無などが異なります。

このアプリでは、管理者が案件と勤務枠を作成し、従業員の勤務不可情報を考慮しながらシフトを確定できます。

従業員は自分の確定シフトを確認し、勤務後に就労報告を提出します。管理者は就労報告を承認し、月次の勤務時間や給与見込みを確認できます。
